    ...
    return (
      <div className="empty-state">
        ...
        <div className="empty-state-message">
          Loading distributed jobs status...
        </div>
      </div>
    );
  }
      ...
      <div>
        <div className="panel-header">
          ...
          <div className="panel-subtitle">
            Monitor queues, background tasks, and distributed transaction flows
          </div>
        </div>
        <div
        ...
        >
          ...
          >
            {data.message ||
              'The jobs scheduler module is not currently registered in the application container.'}
          </p>
          <div
            style={{
      ...
      >
        ...
        >
          ...
          >
            {stats.running}
            {stats.running > 0 && (
              <span className="spinner" style={{ fontSize: '18px' }}>
                ⚙️
              </span>
            )}
          </div>
        ...
        >
          <div
            style={{
              fontSize: '12px',
              color:
                stats.failed > 0 ? 'var(--error)' : 'var(--text-secondary)',
              fontWeight: 600,
              textTransform: 'uppercase',
              letterSpacing: '0.05em',
            }}
          ...
          <div
            style={{
              fontSize: '28px',
              fontWeight: 700,
              color: stats.failed > 0 ? 'var(--error)' : 'var(--text-primary)',
              marginTop: '8px',
            }}
          >
            {stats.failed}
          ...
          <div
            style={{
              ...
              right: '-8px',
              fontSize: '64px',
              opacity: stats.failed > 0 ? 0.08 : 0.05,
              userSelect: 'none',
            }}
          >
            ❌
                ...
                style={{
                  background:
                    statusFilter === filter
                      ...
                      : 'var(--bg-secondary)',
                  color:
                    statusFilter === filter ? '#fff' : 'var(--text-primary)',
                  border: '1px solid var(--border)',
                  padding: '6px 12px',
                  borderRadius: 'var(--radius-md)',
                  cursor: 'pointer',
          ...
          >
            ...
            >
              ...
              >
                ...
                <div>
                  Attempts: {selectedJob.attempts} of {selectedJob.maxAttempts}
                </div>
              </div>
