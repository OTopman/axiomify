...
This folder is the Markdown documentation set for Axiomify.

It is organized in two layers:

- Framework guides for how Axiomify works end-to-end
- Package reference pages for every published package, listed from A-Z
...
- [@axiomify/native](./packages/native.md)
